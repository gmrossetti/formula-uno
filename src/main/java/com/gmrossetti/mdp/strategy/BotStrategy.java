...
class BotStrategy implements IStrategy {
    ...
    private SpeedAction findSpeedAction(CarDriver carDriver){
        ...
        double trajectoryDeviationDegrees = getTrajectoryDeviationDegrees(car, target, pivot);
    ...
    private static double getTrajectoryDeviationDegrees(Car car, GridPoint target, GridPoint pivot) {
        ...
        return trajectoryDeviationDegrees;
    }
